...
export function Header({
  isLoggedIn, onLoginClick, onSignupClick, onLogoutClick, onMyPageClick, onLogoClick, 
  onWizardClick, onFilterClick, showSearch = true, searchQuery = "", onSearchChange, onSearch,
}: HeaderProps) {
  return (
            ...
            <div className="flex-1 max-w-2xl mx-8">
              <div className="w-full flex items-center justify-between px-6 py-3 border border-gray-300 hover:shadow-md rounded-full transition-shadow bg-white">
                <Input 
                  ...
                  className="border-0 bg-transparent focus-visible:ring-0 px-0 text-sm flex-1 shadow-none" 
                />
